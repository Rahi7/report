    ...
    <div className="bg-white text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center text-white">
          ...
          <p className="mt-6 text-xl leading-relaxed drop-shadow-md">
            Medlock is a healthcare management system designed to simplify and
            secure the medical experience for patients and healthcare providers
            alike.
          </p>
        </div>
      </section>
      ...
      <section className="bg-blue-50 py-16 px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-4 text-blue-800 text-lg max-w-3xl mx-auto">
            To provide a secure, efficient, and user-friendly platform that
            connects patients with healthcare providers, simplifies medical
            record handling, and improves the overall healthcare journey.
          </p>
        </div>
      </section>
      ...
      <section className="bg-blue-50 py-16 px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-4 text-blue-800 text-lg max-w-3xl mx-auto">
            We prioritize your privacy. Medlock uses end-to-end encryption and
            complies with all modern healthcare data protection standards to
            safeguard your medical data.
          </p>
        </div>
      </section>
